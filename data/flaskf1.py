...
csv_path = os.path.join(base_dir, 'data', 'F1_2022_data.csv')  # Ruta relativa al archivo CSV
...
# Configurar el puerto y el host
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 5000))  # Usar el puerto especificado por el entorno
